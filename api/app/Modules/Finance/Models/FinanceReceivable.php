...
use Database\Factories\FinanceReceivableFactory;
...
{
    /** @use HasFactory<FinanceReceivableFactory> */
    use BelongsToClient;
    use BelongsToTenant;
    use HasFactory;
    use HasUuid;
    ...
    {
        return sprintf('REC-%06d', $this->number);
    }
    ...
    {
        return $this->hasMany(FinanceReceivableEvent::class, 'receivable_id');
    }

    protected static function newFactory(): FinanceReceivableFactory
    {
        return FinanceReceivableFactory::new();
    }
}
