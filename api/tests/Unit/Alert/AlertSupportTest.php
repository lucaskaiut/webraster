...
class AlertSupportTest extends TestCase
{
    ...
    public function battery_percent_ignores_voltage_values(): void
    {
        ...
        $this->assertSame(94.0, TraccarAttributeReader::batteryPercent(null, ['protocol' => 'easytrack', 'power' => 94]));
        $this->assertNull(TraccarAttributeReader::batteryPercent(null, ['power' => 94]));
        $this->assertNull(TraccarAttributeReader::batteryPercent(null, ['protocol' => 'easytrack', 'power' => 12.6]));
    }
